...
//     let msg1 = Math.floor((Math.random() * 100000) + 1) + (new Date).getTime();
//     let msg2 = Math.floor((Math.random() * 100000) + 1) + (new Date).getTime();
...
//     let buffer = new Buffer('hello, sha1', 'utf8');
